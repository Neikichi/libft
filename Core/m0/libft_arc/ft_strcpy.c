...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/09 16:50:49 by veehome           #+#    #+#             */
/*   Updated: 2024/11/09 16:51:32 by veehome          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/// 
/// This function copies the string `src` 
/// (including the terminating null byte)
/// to the buffer `dest`. The destination buffer must be 
/// large enough to receive the entire string.
/// 
