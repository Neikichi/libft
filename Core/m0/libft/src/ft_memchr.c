...
/// occurrence of the byte `c`. The function returns a pointer to the matching byte or `NULL` if
/// the byte is not found within the specified range.
/// 
/// @param s A pointer to the memory area to be scanned
/// @param c The value to be located, passed as an int but treated as an unsigned char
